...
<main class="container">
    ...
    <div class="btn-group countryButtons" role="group" aria-label="...">
        ...
        foreach ($countries as $i) {
            echo "<a href='list.php?country= $i' role='button' class='btn btn-default' > $i </a>";
        }
        ?>
    ...
    <ul class="caption-style-2">
        ...
        foreach ($images as $i) {
            echo "<li>";
            echo "<a href= 'detail.php?id=" . $i["id"] . "' class='img-responsive'>";
            echo "<img src='images/square/" . $i["path"] . "' alt= " . $i["title"] . ">";
